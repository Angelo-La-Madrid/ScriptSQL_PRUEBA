...
FECREGPAR timestamp, /* SELECT CURDATE() ;*/
NOMPAR VARCHAR (60),
APEPAR VARCHAR (80),
DNIPAR CHAR(8),
TIPPAR CHAR(1),
...
FECCONF DATE,
PONCONF CHAR(5),
primary key CODCONF_PK (CODCONF)
);
...
CODCONF CHAR(5),
CANTPART INT,
primary key IDREGDET_PK (IDREGDET)
);
...
ALTER TABLE PARTICIPANTES
	CONSTRAINT KEY REGISTRO(CODREG_PK) FOREIGN KEY PARTICIPANTES(CODREG_PK);
    
		
/*REGISTRO-REGISTRODETALLE*/
ALTER TABLE REGISTRO
	FOREIGN KEY REGISTRO(CODREG_PK) REGISTRODETALLE(IDREGDET_PK)
